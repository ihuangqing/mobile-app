			...
			<view class="u-p-20">
				<u-card margin="0 0 20rpx 0" :border="false"
					...
					<u-cell-group v-if="!current" slot="body" :border="false">
						<u-cell-item class="u-p-t-10 u-p-b-10" hover-class="none" :arrow="false" title="接收数量"
							:value="material.qty ? (material.unit ? (material.qty + material.unit) : material.qty) : '-'">
						</u-cell-item>
						<u-cell-item class="u-p-t-10 u-p-b-10" hover-class="none" :arrow="false" title="仓库"
							:value="material.shelfName">
						</u-cell-item>
						<u-cell-item class="u-p-t-10 u-p-b-10" hover-class="none" :arrow="false" :border-bottom="false"
							title="接收时间" :value="material.creationDate">
						</u-cell-item>
					</u-cell-group>
					<u-cell-group v-else slot="body" :border="false">
						<u-cell-item class="u-p-t-10 u-p-b-10" hover-class="none" :arrow="false" title="发放人"
							:value="material.deliveryPersonName ? material.deliveryPersonName : '-'">
						</u-cell-item>
						<u-cell-item class="u-p-t-10 u-p-b-10" hover-class="none" :arrow="false" title="发放数量"
							:value="material.qty ? (material.unit ? (material.qty +material.unit) : material.qty ) : '-'">
						</u-cell-item>
						<u-cell-item class="u-p-t-10 u-p-b-10" hover-class="none" :arrow="false" :border-bottom="false"
							title="发放时间" :value="material.creationDate">
						</u-cell-item>
					</u-cell-group>
				</u-card>
	...
	export default {
		...
		methods: {
			getMaterialInList() {
				...
				this.$u.api.getMaterialInList(params).then(res => {
					if (res.msgCode === '000000') {
						...
						this.$refs.uTips.show({
							title: `物料入库记录获取失败，原因：${ res.message }`,
							type: 'error',
							duration: 2300
						})
					}
			...
			getMaterialOutList() {
				...
				this.$u.api.getMaterialOutList(params).then(res => {
					if (res.msgCode === '000000') {
